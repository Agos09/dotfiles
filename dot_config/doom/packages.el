...
;; Ox-hugo for Hugo integration
(package! ox-hugo)

;; Ox-reveal for presentations
(package! ox-reveal)

;; Anki editor for flashcards
(package! anki-editor)

;; DJVU support
(package! djvu)

;; Mermaid mode for diagrams
(package! mermaid-mode)

;; Org-babel support for Mermaid
(package! ob-mermaid)

;; Optional: Copilot for AI assistance (uncomment if needed)
;; (package! copilot
